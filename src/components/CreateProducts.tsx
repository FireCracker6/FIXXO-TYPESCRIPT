...
const CreateProducts = () => {
  ...
  return (
    ...
    <form onSubmit={create} className="d-grid mb-5">
        ...
        <input  onChange={(e) =>  setProductRequest({...productRequest, price: parseFloat(e.target.value)})}  type="number" step="any"  className='form-control py-2 mb-3' placeholder='Enter a price...'  />
